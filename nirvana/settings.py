...
SECRET_KEY = 'django-insecure-h-%t&@&u*z!b21(l_k9#0(#a$@0&5sy+vb$j6!4%h#em!k8g3t'
...
MESSAGE_TAGS={
    ...
    messages.WARNING: 'warning',  # Use 'warning' for warning messages
    messages.INFO: 'info',  # Use 'info' for informational messages
}

LOGIN_REDIRECT_URL = 'store:index'  # Redirect to the store index after login
LOGOUT_REDIRECT_URL = 'store:index'  # Redirect to the store index after logout
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Remove the square brackets
STATICFILES_DIRS = [ BASE_DIR / 'static', ]  # This one is correct as a list
MEDIA_URL = "/media/"
...
JAZZMIN_SETTINGS = {
    "site_title": "Nirvana Technology",
    "site_header": "Nirvana Technology",
    "site_brand": "Nirvana Technology",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "images/logos/logo.jpg",
    "welcome_sign": "Welcome to Nirvana Technology",
    "copyright": "Nirvana Technology",
